...
<link rel="stylesheet" href="resources/Personalization-amico.png" />
...
<body>
	...
	<div style="background-color: #fff;" class="container mt-6">
		 <div class="img-fluid" > <img src="resources/img/Personalization-amico.png" class="rounded float-end" alt="" width="550" height="550" style="margin-top: 15;"></div>
			 </div>
	...
	<div class="container mt-4">
		<h3 style="margin-top: 37; margin-left: 10;">Atualização de Funcionário</h3>
		<br/>
		...
		<form id="formedicao" action="atualizarFuncionario" method="post">
			...
			<div class="row">
				...
				<div class="col-md-8">
					<label><strong>CPF: </strong><strong>${dto.cpf}</strong></label>
					<br/>	
					<label><strong>Matrícula: </strong><strong>${dto.matricula}</strong></label>
					<br/>
					<br/>
					...
					<form:input path="dto.nome" name="nome" id="nome" type="text" class="form-control" style="border-color: #1e0ea6;"/>
					<br/>
